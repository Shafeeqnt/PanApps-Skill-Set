---
name: panapps-angular-standards
description: Use this for angular components, pages, hooks, forms, and frontend refactors that should follow Panapps coding standards and review checklist.
---

# Panapps Angular Standards

## What this skill does
This skill helps the agent create and review angular code using Panapps team conventions.

## When to use
Use this skill when:
- Building new angular components
...
3. Apply Panapps standards for angular.
